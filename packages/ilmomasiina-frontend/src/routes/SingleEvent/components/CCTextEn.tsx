const CCTextEn: string = `We want all guild activities to be safe for everyone. If you see or experience harassment
in the guild community,
please contact a Confidential Counselor or a member of the board.
...
and can also refer to [the Equality Plan](https://as.fi/en/guild/harassment/plan-for-equality) for more details.`;

export default CCTextEn;
